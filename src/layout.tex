...
\definecolor{ink}{HTML}{1A1A1A}    % primary text (name, titles, headline, body)
\definecolor{muted}{HTML}{4D4D4D}  % education lines and footer
\definecolor{meta}{HTML}{666666}   % entry meta lines (employer/years, venues)
...
\newcommand{\makecvheader}{%
  ...
  \begin{paracol}{2}
  {\bfseries\sizename\color{ink}\addfontfeature{LetterSpace=\cvnametracking}\cvname}\\[\namegap]
  {\sizerole\color{accent}{\bfseries\cvrole}\iffield{\cvcompany}{ @ \cvcompany}}\\[\rolegap]
  {\sizeheadline\color{ink}\cvheadline}
  \switchcolumn
  \cvfirstheaderblocktrue
  \iffield{\cvlocation}{\headerblock{LOCATION}{%
    \iffield{\cvlocationurl}{\href{\cvlocationurl}{\cvlocation}}{\cvlocation}}}%
...
% Entry: bold title, muted meta line. Optional URL makes the title a clickable
...
\newcommand{\renderlanguage}[2]{%
  \begin{minipage}[t]{\cvlangcellwidth\columnwidth}{\bfseries #1}\\[\langlinegap]{\color{meta}#2}\end{minipage}}
% Small-print footer.
\newcommand{\cvfooter}[1]{%
  \vfill{\sflight\sizefooter\color{muted} #1\par}}
...
%   \projectsnote{Trailing italic note under the projects.}
...
\newcommand{\job}[5][]{%
  ...
  \fi}
\newcommand{\project}[4][]{\appendto\cvprojects{\entry[#1]{#2}{#3}\body{#4}}}
\newcommand{\projectsnote}[1]{\appendto\cvprojectsnote{\body{\itshape #1}}}
\newcommand{\publication}[3][]{\appendto\cvpubs{\entry[#1]{#2}{#3}}}
...
\newcommand{\makecv}{%
  ...
  \rightcolumn
    \cvworkright
    \cvsection{projects}{MAIN PROJECTS}\cvprojects\cvprojectsnote
